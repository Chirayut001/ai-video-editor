...
def _gen_config(json_mode: bool):
    """คืน config บังคับ JSON output (structured) เมื่อ json_mode=True"""
    if json_mode:
...
"""
    ...
    def _run_deletion():
        ...
        return call_gemini_with_retry(full_prompt, json_mode=True)
...
"""
    ...
    response_text = call_gemini_with_retry(tiktok_prompt, json_mode=True)
